...
<div class="content">
  <div class="panel panel-flat">
    <div class="table-responsive">
      <table class="table text-nowrap" id="silent-table">
        <thead>
          <tr>
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    var table = document.getElementById("silent-table");
    var leng = document.getElementById('silent-table').rows.length-1;
    var td_content = document.getElementById("silent-table").rows[leng].cells[0].innerHTML;
    if( td_content != "No silent case(s) found." ){
      var x = setInterval(
      function () {
