				...
				<form class="form-horizontal" id="form-general-info">
					...
					<fieldset class="content-group">
						...
						<div class="form-group">
							...
							<div class="col-lg-8">
								<input type="text" class="form-control" name="company_name" value="{{ $data[0]->company_name }}" required>
							</div>
						</div>
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
	  ...
	  $(".menu-admin-console-general").addClass('active');
	
	  $( "#form-general-info" ).submit(function( e ) {
			$.ajax({ 
	      type: "POST", 
	      url: "{{ url('admin/general-info') }}",
