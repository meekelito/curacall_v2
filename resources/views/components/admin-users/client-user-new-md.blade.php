...
<div class="modal-header bg-primary">
	...
	<h5 class="modal-title">New Client User</h5>
</div>
<form class="form-horizontal" id="form-client-user-new">
	{{ csrf_field() }}
	<div class="modal-body">
		...
		<!-- <div class="form-group form-group-xs">
			<label class="control-label col-lg-3 text-right">Primary Account :</label>
			<div class="col-lg-9">
...
<script type="text/javascript">
  // $(".bootstrap-select").selectpicker();
	...
	$( "#form-client-user-new" ).submit(function( e ) {
		$.ajax({ 
      type: "POST",
