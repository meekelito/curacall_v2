<div class="modal-header bg-primary">
	...
	<h5 class="modal-title">Update CuraCall User Information</h5>
</div>
<form class="form-horizontal" id="form-admin-user-update">
	{{ csrf_field() }}
	...
	<div class="modal-body">
		...
		<div class="form-group form-group-xs">
			...
			<div class="col-lg-8">
				<input type="email" class="form-control" value="{{ $data[0]->email }}" name="email" required>
			</div>
		</div>
...
<script type="text/javascript">
	...
	$( "#form-admin-user-update" ).submit(function( e ) {
		$.ajax({  
      type: "POST",
      url: "{{ url('admin/update-admin-user') }}",
      data: $('#form-admin-user-update').serialize(),
